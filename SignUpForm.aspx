<%@ Page Title="" Language="C#" MasterPageFile="~/secondmaster.master" AutoEventWireup="true" CodeFile="SignUpForm.aspx.cs" Inherits="SignUpForm" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Join library</label>
                    ...
                    <!--Fourth row of Input Image end-->
                     <center>
                        ...
                        <asp:Button   ID="Button1" runat="server" Text="Insert" CssClass="btn btn-primary btn-info-full " Width="65%" Height="15%"  ></asp:Button>
                         </center>
                        <br /><br />
