<%@ Page Title="" Language="C#" MasterPageFile="~/secondmaster.master" AutoEventWireup="true" CodeFile="StartExam.aspx.cs" Inherits="StartExam" %>
...
<asp:Label ID="lbstatus" runat="server"></asp:Label>  
                            ...
                            <tr>  
                                <td style="text-align: center;">  
                                    <asp:Button ID="btnStartTest" Text="Start Test" runat="server" OnClientClick="return StartTest('MCQExam.aspx');" CssClass="btn" />  
                                </td>  
                            </tr>  
                        </table>  
                    </div>  
